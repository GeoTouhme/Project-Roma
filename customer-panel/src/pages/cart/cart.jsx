...
const Cart = () => {
  ...
  const subtotal = cartItems.reduce((total, item) => total + (item.priceSale || item.salePrice || item.price) * item.quantity, 0);
                  ...
                  {cartItems.length === 0 ?
                    <tr>
                      ...
                      <tr key={item.id} className="border-t">
                        ...
                        <td className="p-4">${item.priceSale || item.salePrice || item.price}</td>
                        <td className="p-4">
                          <select
                            value={item.quantity}
                        ...
                        <td className="p-4">${((item.priceSale || item.salePrice || item.price) * item.quantity).toFixed(2)}</td>
                      </tr>
                    ))}
                </tbody>
              </table>
