      ...
      <div className="footer_subscription bg-primary md:py-[58px] py-8 relative">
        <div className="container">
          ...
          <div className="subscribe_form">
            <form className="form flex items-center gap-2 justify-center flex-wrap">
              <input className="px-5 md:py-3 py-2 rounded-lg max-w-[650px] w-full text-[18px]" placeholder="Email" name="subscribe_email" id="subscribe_email" />
              <button type="submit" id="subscribe_btn" className="bg-white md:px-10 px-7 md:py-3 py-2 inline-block rounded-lg text-primary font-medium text-[18px]">Subscribe</button>
            </form>
          </div>
        </div>
        ...
        <div className="container">
          <div className="footer_blocks flex justify-between gap-x-5 gap-y-10 flex-wrap xl:flex-nowrap">
            <div className="footer_about">
              ...
              <p className="text-white pe-10">Welcome to our store, where we pride ourselves on provuding exceptional products and unparalleled customer service our store style, and innovation.</p>
            ...
            <div className="footer_menu min-w-[190px]">
              <h2 className="text-white uppercase text-[20px]/[20px] font-medium mb-5">Quick Links</h2>
              <div className="footer_menu_links grid gap-3">
                <Link to="#" className="text-white tracking-[0.5px] text-[16px]/[20px] hover:text-primary">New Products</Link>
                <Link to="#" className="text-white tracking-[0.5px] text-[16px]/[20px] hover:text-primary">About Us</Link>
                <Link to="#" className="text-white tracking-[0.5px] text-[16px]/[20px] hover:text-primary">Contact Us</Link>
              </div>
            </div>
            <div className="footer_menu min-w-[190px]">
              <h2 className="text-white uppercase text-[20px]/[20px] font-medium mb-5">Services</h2>
              <div className="footer_menu_links grid gap-3">
                <Link to="#" className="text-white tracking-[0.5px] text-[16px]/[20px] hover:text-primary">Privacy Policy</Link>
                <Link to="#" className="text-white tracking-[0.5px] text-[16px]/[20px] hover:text-primary">FAQs</Link>
                <Link to="#" className="text-white tracking-[0.5px] text-[16px]/[20px] hover:text-primary">Terms & Conditions</Link>
              </div>
            </div>
            <div className="footer_menu min-w-[190px]">
            ...
            <div className="footer_contact">
              ...
              <div className="contact_details grid gap-4">
                ...
                <Link to="tel:(+91) 0123-456-789" className="flex items-start gap-2.5">
                  <div className="min-w-4">
                ...
                <Link to="tel:(+00) 123-456-7890" className="flex items-start gap-2.5">
                  <div className="min-w-4">
          ...
          border-t border-[#9B9B9B]/30 flex-wrap gap-5">
            ...
            <img src={PaymentImage} className="max-w-full" />
          </div>
        </div>
      </div>
    </div>
