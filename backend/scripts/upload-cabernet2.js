...
const RESULTS_PATH = path.resolve(__dirname, '../../data/cabernet2-match-results.json');
const IMAGES_DIR = path.resolve(__dirname, '../../data/extracted-images/new-zip-2026-08-12');
const LOG_PATH = path.resolve('/tmp/cabernet2-upload.log');
...
async function main() {
  ...
  fs.writeFileSync(LOG_PATH, `Cabernet (2) upload: ${toUpload.length} items\n`);
